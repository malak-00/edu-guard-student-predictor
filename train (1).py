...
rf = RandomForestClassifier(n_estimators=150, max_depth=18, random_state=RANDOM_STATE)
...
rf_final = RandomForestClassifier(n_estimators=150, max_depth=18, random_state=RANDOM_STATE)
